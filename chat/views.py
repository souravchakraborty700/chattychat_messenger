...
def user_list(request):
    ...
    return render(request, 'chat/user_list.html', {'contacts': contacts})
...
def send_interest(request, user_id):
    ...
    return render(request, 'chat/send_interest.html', {'recipient': recipient})

@login_required
def received_interests(request):
    interests = request.user.received_interests.filter(accepted=False, rejected=False)
    return render(request, 'chat/received_interests.html', {'interests': interests})
...
def chat_box(request, interest_id):
    ...
    return render(request, 'chat/chatbox.html', {'interest': interest, 'user': request.user})
...
def send_message(request, interest_id):
    ...
    if request.method == 'POST':
        ...
        if text:
            ...
            message.save()
            return redirect('chat_box', interest_id=interest.id)
    return render(request, 'chat/chatbox.html', {'interest': interest})
...
def connect(request):
    ...
    return render(request, 'chat/connect.html', {'contacts': contacts})
